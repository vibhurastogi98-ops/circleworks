...
export default function HiringDashboard() {
  ...
  const activeJobs = isNewUser ? [] : mockAtsJobs.filter(j => j.status === "Active");
  const applicants = isNewUser ? 0 : mockAtsCandidates.length;
  
  // Pipeline Funnel Mock Data
  const funnel = isNewUser ? [
    { label: "New Applicants", value: 0, percentage: 0 },
    { label: "Screening", value: 0, percentage: 0 },
    { label: "Onsite", value: 0, percentage: 0 },
    { label: "Offers", value: 0, percentage: 0 },
    { label: "Hired", value: 0, percentage: 0 },
  ] : [
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
         ...
         <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm flex items-start justify-between">
             <div>
                ...
                <div className="text-2xl font-bold text-slate-900 dark:text-white">{isNewUser ? "0 days" : "28 days"}</div>
             </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm flex items-start justify-between">
             <div>
                ...
                <div className="text-2xl font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "88%"}</div>
             </div>
         ...
         <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
             ...
             <div className="flex flex-col gap-5">
                <div className="flex items-center justify-between">
                   ...
                   <span className="font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "45%"}</span>
                </div>
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "25%"}</span>
                </div>
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "15%"}</span>
                </div>
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "10%"}</span>
                </div>
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-slate-900 dark:text-white">{isNewUser ? "0%" : "5%"}</span>
                </div>
             </div>
         </div>
      </div>
