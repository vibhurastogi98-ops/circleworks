                 ...
                 <div className="bg-white rounded-[2rem] p-8 lg:p-12 shadow-2xl relative overflow-hidden h-full">
                    {submitted ? (
                       ...
                       <form onSubmit={handleSubmit} className="space-y-6">
                          ...
                          <button disabled={loading} type="submit" className="w-full relative py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold rounded-xl overflow-hidden group shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 mt-4 disabled:opacity-50">
                             <div className="absolute inset-0 bg-white/20 w-1/2 -skew-x-12 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]" />
                             <span className="relative z-10">{loading ? "Sending..." : "Submit Request"}</span>
                          </button>
                       </form>
                    )}
                 </div>
