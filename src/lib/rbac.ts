...
export const builtInRoles: BuiltInRoleDefinition[] = [
  ...
  },
  {
    id: "contractor",
    name: "Contractor",
    normalizedNames: ["contractor", "1099 contractor", "1099_contractor", "vendor"],
    description: "Contractor self-service portal access for invoices, payments, tax forms, and contracts.",
    userCount: 12,
    nonDeletable: true,
    permissions: ["view_contractor_portal"],
  },
  {
    id: "accountant",
    name: "Accountant",
...
export const screenPermissionRules: Array<{ prefix: string; permission: string }> = [
  ...
  { prefix: "/compliance/federal-filings", permission: "view_tax_filings" },
  { prefix: "/compliance/pay-equity", permission: "view_pay_equity" },
  { prefix: "/compliance/paid-leave", permission: "view_paid_leave" },
...
export const apiPermissionRules: Array<{ method?: string; prefix: string; permission: string }> = [
  ...
  { prefix: "/api/payroll/royalty-schedules", permission: "manage_earnings" },
  ...
  { method: "PATCH", prefix: "/api/assets/assign", permission: "return_assets" },
  ...
  { method: "GET", prefix: "/api/announcements", permission: "view_me_dashboard" },
  { method: "PATCH", prefix: "/api/announcements", permission: "manage_notifications" },
  { method: "DELETE", prefix: "/api/announcements", permission: "manage_notifications" },
  { method: "POST", prefix: "/api/announcements", permission: "view_me_dashboard" },
  { prefix: "/api/automations", permission: "manage_workflows" },
