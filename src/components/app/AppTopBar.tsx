                        ...
                        <>
                          {canOpenWorkspaceSettings ? (
                            <button
                              ...
                              onClick={() => {
                                setIsAvatarMenuOpen(false);
                                router.push(`/settings/${normalizedAccountType}/workspace`);
                              }}
                              className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[13px] font-medium text-slate-700 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
                            >
                          ...
                          <button
                            ...
                            onClick={() => {
                              setIsAvatarMenuOpen(false);
                              router.push(`/settings/${normalizedAccountType}/profile`);
                            }}
                            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[13px] font-medium text-slate-700 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
                          >
                          ...
                          <button
                            ...
                            onClick={() => {
                              setIsAvatarMenuOpen(false);
                              router.push(`/settings/${normalizedAccountType}/business`);
                            }}
                            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[13px] font-medium text-slate-700 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
                          >
                            <Settings size={16} className="text-slate-400" />
                          ...
                          <button
                            ...
                            onClick={() => {
                              setIsAvatarMenuOpen(false);
                              router.push(`/settings/${normalizedAccountType}/billing`);
                            }}
                            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[13px] font-medium text-slate-700 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
                          >
